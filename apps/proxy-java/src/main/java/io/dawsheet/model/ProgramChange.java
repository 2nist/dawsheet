...
public class ProgramChange {
    ...
    private ProgramChangeProperties properties;
    ...
    public ProgramChangeProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(ProgramChangeProperties value) { this.properties = value; }
