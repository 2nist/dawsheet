...
public class TransformOp {
    ...
    private TransformOpProperties properties;
    ...
    public TransformOpProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(TransformOpProperties value) { this.properties = value; }
