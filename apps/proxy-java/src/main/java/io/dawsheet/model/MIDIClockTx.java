...
public class MIDIClockTx {
    private String type;
    private String[] required;
    private MIDIClockTxProperties properties;
    ...
    public MIDIClockTxProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(MIDIClockTxProperties value) { this.properties = value; }
