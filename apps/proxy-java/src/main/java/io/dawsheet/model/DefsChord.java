...
public class DefsChord {
    private String type;
    private String[] required;
    private ChordProperties properties;
    ...
    public ChordProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(ChordProperties value) { this.properties = value; }
