...
public class Scale {
    ...
    private ScaleProperties properties;
    ...
    public ScaleProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(ScaleProperties value) { this.properties = value; }
