...
public class CueGoto {
    private AftertouchType type;
    private String[] required;
    private CueGotoProperties properties;
    ...
    public CueGotoProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(CueGotoProperties value) { this.properties = value; }
